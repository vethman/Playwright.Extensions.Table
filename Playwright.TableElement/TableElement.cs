...
namespace Playwright.Table
{
    ...
    public class TableElement : ITableElement
    {
        ...
        public TableElement(ILocator locatorHeaders, ILocator locatorRows) : this(locatorHeaders, locatorRows, "td")
        {
        }
        ...
        /// <param name="rowColumnSelector">Selector to find elements inside a row representing the columns</param>
        public TableElement(ILocator locatorHeaders, ILocator locatorRows, string rowColumnSelector)
        {
        ...
        public async Task<IReadOnlyList<ITableRowElement>> GetTableRowElementsAsync()
        {
            ...
            {
                var tableRowElement = new TableRowElement(headerIndexer, _locatorRows.Nth(i), _rowColumnSelector);
