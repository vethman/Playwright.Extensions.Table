...
using Playwright.Table.UiTests.PageObjects;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace Playwright.Table.UiTests
{
    public class TableElementTests
    {
        ...
        public async Task SimpleTable_GetColumnIndex_TableRowElementNotLoaded_ThrowsPlaywrightException()
        {
            ...
            act.Should().Throw<IndexOutOfRangeException>()
                .WithMessage("Columns not loaded into TableRowElement yet. First run LoadAsync...");
        }
        ...
        public async Task SimpleTable_LoadAsync_RowLocatorNoResults_ThrowsPlaywrightException()
        {
            ...
            await act.Should().ThrowAsync<PlaywrightException>()
                .WithMessage("No results found for RowLocator...");
        }
        ...
        public async Task ButtonTable_ClickButtonInRow()
        {
            ...
            var buttonTableRows = await buttonTable.ButtonTableRowsAsync();
            ...
            buttonTableRows = await buttonTable.ButtonTableRowsAsync();
